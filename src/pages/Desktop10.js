      ...
      <nav className="nav-container" id="navContainer">
        <div className="nav-items relative">
          <div className="absolute left-[8rem]">
            <div className="cursor-pointer circle [text-decoration:none]" onClick={handlePage1ButtonSubmit}>
              <div className="text-black ml-[-2rem] mt-[0.6rem]">1</div>
              <div
              
               className="mt-5 text-xl w-32 text-black ml-[-1rem]">
                Customer Info
              </div>
            </div>
            <div
      ...
      <div className="grid w-[70%] m-auto gap-5 mt-10">
        ...
        //  onClick={handleLinkClick('demo')}
          ...
          > */}
            ...
            style={{backgroundColor:activeLink==='demo'?'#EB5351':'whitesmoke',color:activeLink==='demo'?'white':'black',cursor:"pointer"}}
            className=" relative rounded-31xl bg-whitesmoke-200 shadow-[5px_5px_7px_2px_rgba(0,_0,_0,_0.25)] w-[382px] h-[143px] ">
              <div style={{color:activeLink==='demo'?'white':'black',cursor:"pointer"}}className="absolute left-14 top-3 text-xl font-hp-simplified-jpan text-black ">
          ...
          > */}
            ...
            style={{backgroundColor:activeLink==='production'?'#EB5351':'whitesmoke',color:activeLink==='production'?'white':'black',cursor:"pointer"}}
            className=" relative rounded-31xl bg-whitesmoke-200 shadow-[5px_5px_7px_2px_rgba(0,_0,_0,_0.25)] w-[382px] h-[143px] ">
              <div style={{color:activeLink==='production'?'white':'black',cursor:"pointer"}}className="absolute left-10 top-3 text-xl font-hp-simplified-jpan text-black ">
          ...
          > */}
            <div 
              ...
              style={{backgroundColor:activeLink==='trial'?'#EB5351':'whitesmoke',color:activeLink==='trial'?'white':'black',cursor:"pointer"}}
            className=" relative rounded-31xl bg-whitesmoke-200 shadow-[5px_5px_7px_2px_rgba(0,_0,_0,_0.25)] w-[382px] h-[143px] ">
              <div style={{color:activeLink==='trial'?'white':'black',cursor:"pointer"}}className="absolute left-10 top-3 text-xl font-hp-simplified-jpan text-black ">
          ...
          {/* <Link
            ...
            autoFocus
            // onClick={handleLinkClick('perpetual')}
            // onClick={() => {
            //   setFormData({
            //     ...formData,
            //     licenseType: "Perpetual",
          ...
          > */}
            <div 
              ...
              style={{backgroundColor:activeLink==='perpetual'?'#EB5351':'whitesmoke',color:activeLink==='perpetual'?'white':'black',cursor:"pointer"}}
            className=" relative rounded-31xl bg-whitesmoke-200 shadow-[5px_5px_7px_2px_rgba(0,_0,_0,_0.25)] w-[382px] h-[143px]">
              <div
               style={{color:activeLink==='perpetual'?'white':'black',cursor:"pointer"}}
